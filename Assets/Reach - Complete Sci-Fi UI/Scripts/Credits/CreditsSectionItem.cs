...
namespace Michsky.UI.Reach
{
    public class CreditsSectionItem : MonoBehaviour
    {
        ...
        {
            GameObject go = Instantiate(namePreset, new Vector3(0, 0, 0), Quaternion.identity);
        ...
        public void CheckForLocalization(string key)
        {
            ...
            if (localizedObject == null || !localizedObject.CheckLocalizationStatus()) { localizedObject = null; }
