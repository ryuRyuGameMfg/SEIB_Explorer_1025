...
namespace Michsky.UI.Reach
{
    ...
    public class NotificationManager : MonoBehaviour
    {
        ...
        {
            yield return new WaitForSeconds(ReachUIInternalTools.GetAnimatorClipLength(itemAnimator, "Notification_In"));
            itemAnimator.enabled = false;
        }

        IEnumerator DisableItem()
        {
            yield return new WaitForSeconds(ReachUIInternalTools.GetAnimatorClipLength(itemAnimator, "Notification_Out"));
