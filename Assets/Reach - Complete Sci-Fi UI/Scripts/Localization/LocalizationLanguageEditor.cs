...
namespace Michsky.UI.Reach
{
    ...
    public class LocalizationLanguageEditor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            // Info Header
            ReachUIEditorHandler.DrawHeader(customSkin, "Header_Content", 8);
            ...
            GUI.enabled = false;
            ReachUIEditorHandler.DrawProperty(languageID, customSkin, "Language ID");
            ReachUIEditorHandler.DrawProperty(languageName, customSkin, "Language Name");
            ReachUIEditorHandler.DrawProperty(localizedName, customSkin, "Localized Name");
            GUI.enabled = true;
            ...
            // Header_Content
            ReachUIEditorHandler.DrawHeader(customSkin, "Header_Tables", 14);
