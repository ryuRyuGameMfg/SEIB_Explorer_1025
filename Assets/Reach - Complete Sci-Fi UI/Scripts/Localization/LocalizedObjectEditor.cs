...
namespace Michsky.UI.Reach
{
    ...
    public class LocalizedObjectEditor : Editor
    {
        ...
        private void OnEnable()
        {
            ...
            if (EditorGUIUtility.isProSkin) { customSkin = ReachUIEditorHandler.GetDarkEditor(customSkin); }
            else { customSkin = ReachUIEditorHandler.GetLightEditor(customSkin); }

            if (loTarget.localizationSettings == null
                && Resources.Load<UIManager>("Reach UI Manager") != null
                && Resources.Load<UIManager>("Reach UI Manager").localizationSettings != null)
            {
                loTarget.localizationSettings = Resources.Load<UIManager>("Reach UI Manager").localizationSettings;
            }
        ...
        public override void OnInspectorGUI()
        {
            ...
            switch (currentTab)
            {
                case 0:
                    ...
                    ReachUIEditorHandler.DrawProperty(localizationSettings, customSkin, "Loc. Settings");
                    GUI.enabled = true;
