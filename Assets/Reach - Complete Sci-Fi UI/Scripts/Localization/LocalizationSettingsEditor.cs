...
namespace Michsky.UI.Reach
{
    ...
    public class LocalizationSettingsEditor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            ReachUIEditorHandler.DrawHeader(customSkin, "Header_Languages", 14);
            GUILayout.Space(-3);
            ...
            enableExperimental.boolValue = ReachUIEditorHandler.DrawToggle(enableExperimental.boolValue, customSkin, "Enable Experimental Features");
            #endregion

            #region Support
            ReachUIEditorHandler.DrawHeader(customSkin, "Header_Support", 14);
