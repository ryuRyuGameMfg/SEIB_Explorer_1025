...
namespace Michsky.UI.Reach
{
    ...
    public class HomeButtonIconHandler : MonoBehaviour
    {
        ...
        void Start()
        {
            ...
            if (EventSystem.current.currentSelectedGameObject == buttonManager.gameObject)
            {
                DoIn();
            }
        }
        ...
        void OnDisable()
        {
            if (!buttonManager.enableIcon || rect == null || canvasGroup == null)
                return;
        ...
        void DoOut()
        {
            if (!buttonManager.enableIcon || !gameObject.activeInHierarchy)
                return;
