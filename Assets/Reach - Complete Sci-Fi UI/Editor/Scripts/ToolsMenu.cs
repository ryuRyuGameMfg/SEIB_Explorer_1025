...
namespace Michsky.UI.Reach
{
    public class ToolsMenu : Editor
    {
        ...
        [MenuItem("GameObject/Reach UI/Button/Button (Shop)", false, 8)]
        ...
        [MenuItem("GameObject/Reach UI/Notification/Standard Notification", false, 8)]
        static void CreateNotification() { CreateObject("UI Elements/Notification/Notification"); }

        [MenuItem("GameObject/Reach UI/Notification/Feed Notification", false, 8)]
        ...
        [MenuItem("GameObject/Reach UI/Panels/Panel Manager", false, 8)]
        ...
        [MenuItem("GameObject/Reach UI/Selectors/Vertical Selector", false, 8)]
        static void CreateVerticalSelector() { CreateObject("UI Elements/Selectors/Vertical Selector"); }
        ...
        [MenuItem("GameObject/Reach UI/Timer/Timer Bar", false, 8)]
